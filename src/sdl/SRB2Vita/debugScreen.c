...
/*
* Re-register the debug screen framebuffer after something else (e.g. the
* vitaGL init) has taken over the display; the text already drawn is kept
*/
int psvDebugScreenRearm() {
	if (!initialized)
		return -1;
#ifdef NO_psvDebugScreenInit
	return 0;
